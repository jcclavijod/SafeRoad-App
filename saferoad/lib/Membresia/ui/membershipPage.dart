// ignore_for_file: file_names, avoid_print, depend_on_referenced_packages, unused_import, use_build_context_synchronously
          ...
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<int>(
                ...
                initialData:
                    _bloc.selectedDuration, // Use the initial value from BLoC
                ...
                onPressed: () async {
                  ...
                  if (user != null) {
                    ...
                    if (hasActiveMembership) {
                      ...
                      Alertas.showSuccessAlert(
                          context, 'Gracias por confiar en nuestro servicio.');
                    }
                  } else {
